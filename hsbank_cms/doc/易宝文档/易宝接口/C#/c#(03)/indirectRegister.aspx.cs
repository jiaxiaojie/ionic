...
{
	/// <summary>
	/// indirectRegister 的摘要说明。
	/// </summary>
	public class indirectRegister : System.Web.UI.Page
	{
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			// 调用提交函数并获得返回结果字符串  参数一：IndirectRegister为提交业务类型,参数二：Params为参数集合,参数参数三：1为服务器重定向;2为服务器点对点通讯
			string resultStr = req.returnResult("IndirectRegister", Params, "1");
			// 输出结果
