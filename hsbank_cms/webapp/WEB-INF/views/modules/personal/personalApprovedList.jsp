...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/personal/personalTailor/">私人订制审核列表</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>备注信息</th>
				<th>状态</th>
				<shiro:hasPermission name="personal:personalApproved:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="personalTailor">
			<tr>
				<td><a href="${ctx}/personal/personalApproved/form?id=${personalTailor.id}">
					${personalTailor.name}
				</a></td>
				<td>
					${personalTailor.code}
				...
				<shiro:hasPermission name="personal:personalTailor:edit"><td>
    				<a href="${ctx}/personal/personalApproved/form?id=${personalTailor.id}">审核</a>
