...
<body>
	...
	<form:form id="searchForm" modelAttribute="creditInvestUserInfo" action="${ctx}/credit/creditInvestUserInfo/list" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>出生年份：</label>
				...
				<input name="investorBirthYear" id="startdt" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="${creditInvestUserInfo.investorBirthYear }"
					onclick="WdatePicker({dateFmt:'yyyy',maxDate:'#F{$dp.$D(\'enddt\')}',isShowClear:true});"/>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="creditInvestUserInfo">
			...
			<tr>
				...
				<td><fmt:formatDate value="${creditInvestUserInfo.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
