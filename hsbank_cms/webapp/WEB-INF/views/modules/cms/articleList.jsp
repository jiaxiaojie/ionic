				...
				<td>
					...
					<shiro:hasPermission name="cms:article:edit">
	    				...
	    				<shiro:hasPermission name="cms:article:audit">
							...
							<a href="${ctx}/cms/article/delete?id=${article.id}${article.delFlag ne 0?'&isRe=true':''}&categoryId=${article.category.id}" onclick="return confirmx('确认要${article.delFlag ne 0?'删除':'删除'}该文章吗？', this.href)" >${article.delFlag ne 0?'删除':'删除'}</a>
						</c:if>
						</shiro:hasPermission>
					</shiro:hasPermission>
				</td>
