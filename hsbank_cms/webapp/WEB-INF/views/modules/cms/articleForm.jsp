	...
	<form:form id="inputForm" modelAttribute="article" action="${ctx}/cms/article/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">推荐尺寸：260 x 160</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">来源Logo:</label>
			<div class="controls">
				<form:hidden id="copyFromLogo" path="articleData.copyFromLogo" htmlEscape="false" class="input-xlarge"/>
				<sys:ckfinder input="copyFromLogo" type="images" uploadPath="/cms/article/logo" selectMultiple="false"/>
				<span class="help-inline">推荐尺寸：70 x 16</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<a id="relationButton" href="javascript:void(0)" class="btn">添加相关</a>
				<script type="text/javascript">
					var articleSelect = [];
