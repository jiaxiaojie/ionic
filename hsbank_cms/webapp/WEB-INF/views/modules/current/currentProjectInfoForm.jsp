...
<head>
	...
	function init(){
		...
		window.setTimeout(initSelect,300); 
...
<body>
	...
	<ul class="nav nav-tabs">
			<li><a href="${ctx}/current/currentProjectInfo/">活期项目信息列表</a></li>
			<li class="active"><a href="${ctx}/current/currentProjectInfo/form?id=${currentProjectInfo.id}">活期项目信息<shiro:hasPermission name="current:currentProjectInfo:edit">${not empty currentProjectInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="current:currentProjectInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	...
	<form:form id="inputForm" modelAttribute="currentProjectInfo" action="${ctx}/current/currentProjectInfo/create" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="netWorth" name="netWorth"  class="input-xlarge  number required" value="<fmt:formatNumber value="${currentProjectInfo.netWorth}" pattern="#0.##" />" maxlength="7" readonly="readonly" type="text">
			</div>
		</div>
		<div class="control-group">
...
${currentProjectInfo.interestCalculateRule}</textarea>
		...
		<div class="form-actions">
			<shiro:hasPermission name="current:currentProjectInfo:edit"><c:choose>
