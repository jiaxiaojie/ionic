...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/current/currentProjectInfo/reviewList">活期项目审批列表</a></li>
		<li class="active"><a href="${ctx}/current/currentProjectInfo/reviewForm?id=${currentProjectInfo.id}">活期项目审批</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="currentProjectInfo" action="${ctx}/current/currentProjectInfo/review" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
			<textarea rows="2" id="tips" readonly="readonly" name="buyRule" htmlEscape="false"
...
${currentProjectInfo.interestCalculateRule}</textarea>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" value="活期" readonly="readonly" name="duration" 
					maxlength="100" class="input-xxlarge required" />
			</div>
		</div>
		...
		<div class="form-actions">
			<shiro:hasPermission name="current:currentProjectInfo:review">
