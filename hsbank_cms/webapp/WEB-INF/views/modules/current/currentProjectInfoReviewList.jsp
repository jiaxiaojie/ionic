...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/current/currentProjectInfo/reviewList">活期项目审批列表</a></li>
		
	</ul>
	<form:form id="searchForm" modelAttribute="currentProjectInfo" action="${ctx}/current/currentProjectInfo/reviewList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>项目状态</th>
				<th>清盘状态</th>
				<shiro:hasPermission name="current:currentProjectInfo:review"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="currentProjectInfo">
			<tr>
				<td><a href="${ctx}/current/currentProjectInfo/reviewForm?id=${currentProjectInfo.id}">
				...
				<shiro:hasPermission name="current:currentProjectInfo:review"><td>
    				<a href="${ctx}/current/currentProjectInfo/reviewForm?id=${currentProjectInfo.id}">审批</a>
