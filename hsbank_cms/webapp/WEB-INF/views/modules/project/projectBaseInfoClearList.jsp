...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/project/projectBaseInfo/clearlist">借贷产品列表</a></li>
	...
	<form:form id="searchForm" modelAttribute="projectBaseInfo" action="${ctx}/project/projectBaseInfo/clearlist" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectBaseInfo">
			<tr>
				<td><a href="${ctx}/project/projectBaseInfo/form?backPath=clearlist&id=${projectBaseInfo.projectId}">
