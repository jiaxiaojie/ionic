...
<body>
	...
	<form:form id="searchForm" modelAttribute="projectBaseInfo" action="${ctx}/project/projectBaseInfo/querylist" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectBaseInfo">
			<tr>
				<td><a href="${ctx}/project/projectBaseInfo/form?backPath=querylist&pageType=jdProjectInfoMenus&id=${projectBaseInfo.projectId}">
