...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/project/projectWillLoan/list">借贷意向列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="projectWillLoan" action="${ctx}/project/projectWillLoan/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectWillLoan">
			<tr>
				...
				<td>
					${projectWillLoan.confirmUser.name}
				</td>
				<td>
				...
				<shiro:hasPermission name="project:projectWillLoan:view">
    				<a href="${ctx}/project/projectWillLoan/viewform?id=${projectWillLoan.id}">查看</a>
				</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
