...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/project/projectBaseInfo/reviewlist">借贷产品列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="projectBaseInfo" action="${ctx}/project/projectBaseInfo/reviewlist" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectBaseInfo">
			<tr>
				<td><a href="${ctx}/project/projectBaseInfo/reviewform?backPath=reviewlist&id=${projectBaseInfo.projectId}">
				...
				<td>
					 <c:choose>
					    <c:when test="${projectBaseInfo.projectStatus==1}">
					      <a href='${ctx}/project/projectBaseInfo/reviewform?id=${projectBaseInfo.projectId}'>审批</a>
					    </c:when>
					    <c:otherwise>
					      <a href='${ctx}/project/projectBaseInfo/viewform?id=${projectBaseInfo.projectId}'>查看</a>
					    </c:otherwise>   
					  </c:choose>
				</td>
			</tr>
