...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/project/projectBaseInfo/createlist">借贷产品列表</a></li>
		<shiro:hasPermission name="project:projectBaseInfo:create"><li><a href="${ctx}/project/projectBaseInfo/createform">借贷产品创建</a></li></shiro:hasPermission>
	</ul>
		...
		<ul class="ul-form">
			...
			<li><label>项目状态：</label>
				<form:select path="projectStatus" class="input-medium">
					<form:option value="" label="全部"/>
					<form:options items="${fns:getDictList('project_status_dict')}" itemLabel="label" itemValue="value" htmlEscape="true"/>
				</form:select>
			</li>
			<li><label>新手项目：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectBaseInfo">
			<tr>
				...
				<td>
    				<a href="${ctx}/project/projectBaseInfo/copy?projectId=${projectBaseInfo.projectId}">复制</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
