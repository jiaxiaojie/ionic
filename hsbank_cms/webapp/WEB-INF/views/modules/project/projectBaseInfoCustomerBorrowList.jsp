...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/project/projectBaseInfo/borrowerslist?accountId=${projectBaseInfo.customerAccountId}">相关融资项目</a></li>
	...
	<form:form id="searchForm" modelAttribute="projectBaseInfo" action="${ctx}/project/projectBaseInfo/borrowerslist" method="post" class="breadcrumb form-search">
