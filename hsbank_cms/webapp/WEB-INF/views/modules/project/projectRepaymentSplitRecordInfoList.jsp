...
<body>
	...
	<form:form id="searchForm" modelAttribute="projectRepaymentSplitRecord" action="${ctx}/project/projectRepaymentSplitRecord/projectRepaymentSplitRecordInfoList" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<input id="projectId" name="projectId" type="hidden" value="${projectRepaymentSplitRecord.queryProjectId}"/>
		<input id="queryProjectId" name="queryProjectId" type="hidden" value="${projectRepaymentSplitRecord.queryProjectId}"/>
		<ul class="ul-form">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectRepaymentSplitRecord">
			<tr>
				<td><a href="${ctx}/project/projectRepaymentSplitRecord/form?id=${projectRepaymentSplitRecord.splitRecordId}">
