...
.guess-one .all-gray .btn-area a{ color: #8a8a8a;background-color: #d0d0d0;cursor: default; border:none;}
.guess-one .all-gray .btn-area a:hover{ color: #8a8a8a; border:none; background-color: #d0d0d0;cursor: default;}
/*pop up window*/
...
<div class="main" style="display:block">
    ...
    <div class="main-content">
    	...
    	<div class="guess-one" id="one">
        	<div id="joinTeam" class="display-area clearfix all-gray"><!--选择红队后变换按钮状态需要加上class“sel-red-team”，选择蓝队后变换按钮状态需要加上class“sel-blue-team”。-->
            	<div class="btn-area btn-left"><a href="javascript:void(0);">猜TA赢</a></div>
                <div class="btn-area btn-right"><a href="javascript:void(0);">猜TA赢</a></div>
            </div>
            <div class="display-area">
            	<p class="tip-enter"><a href="${ctxFront }/activity/tugWarResult">进入拔河擂台赛>></a></p>
            </div>
        </div>
        <div class="guess-two">
        	<div class="display-area">
