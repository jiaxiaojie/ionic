	...
	<div class="agreement_area">
    	<div class="agreement">
            ...
            <div class="loan_field transfer_field">
            	...
            	<dl class="clearfix">
                	<dt>身份证号码：</dt>
                    <dd>${p2p:vagueCertNum(customerAccount.customerBase.certNum) }</dd>
                </dl>
            	<dl class="clearfix">
                	<dt>通讯地址：</dt>
            ...
            <div class="loan_field transfer_field">
            	<dl class="clearfix">
                	<dt>受让方（以下简称乙方）：</dt>
                    <dd>${p2p:vagueName(transcustomerAccount.customerBase.customerName) }</dd>
                </dl>
            	<dl class="clearfix">
                	<dt>身份证号码：</dt>
                    <dd>${p2p:vagueCertNum(transcustomerAccount.customerBase.certNum) }</dd>
                </dl>
            	<dl class="clearfix">
                	<dt>通讯地址：</dt>
                    <dd>${p2p:vagueAddress(transcustomerAccount.customerBase.address) }</dd>
                </dl>
            	<dl class="clearfix">
                	<dt>花生金服用户名：</dt>
                    <dd>${p2p:vagueName(transcustomerAccount.accountName) }</dd>
                </dl>
            </div>        
            <dl class="item">
                ...
                <dd>
                	<table class="table_loan" width="960" cellpadding="0" cellspacing="0" border="1">
                    	<tbody>
                        	...
                        	<tr>
                        		<td height="40" align="center">债务人</td>
                                <td>${p2p:vagueName(transcustomerAccount.customerBase.customerName) }</td>
                            </tr>
                        	<tr>
                        		<td height="40" align="center">标的债权期限</td>
