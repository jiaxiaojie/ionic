...
<html>
	<head>
		...
		<link href="${ctxStatic}/modules/front/css/layouts/front_with_menu.css?${version }" rel="stylesheet"/>
		<script>
			var sign = function() {
                ...
                <div class="div_right">
                    <ul class="top_menu">
						...
						<c:when test="${not empty p2p:getPrincipal()}">
							<li class="logged" >
                            <a href="${ctxFront}/customer/summary" class="btn_text_black mr10 username"> 
								   <c:choose>
										<c:when
                            ...
                            <a href="javascript:;" class="btn_text_black mr10" style="display: none;">消息<span class="info_tip">9</span></a>
                            <c:choose>
                            ...
                            <a href="${ctxFront}/logout" class="btn_text_black logout">退出</a>
                        </li>
						</c:when>
						<c:otherwise>
							<li class="login_register" style="display: inline-block">
                            	<a href="${ctxFront}/login" class="btn_text_gold mr10">立即登录</a>
                                <a href="${ctxFront}/register" class="btn_text_gold">马上注册</a>
                            </li>
						</c:otherwise>
					</c:choose>
                    </ul>
