...
<link href="${ctxStatic}/modules/front/css/util/util.css?${version }"
	rel="stylesheet" />
<link href="${ctxStatic}/modules/front/css/layouts/front_with_menu.css?${version }"
	rel="stylesheet" />
	<script>
			var sign = function() {
...
<body>
	<c:if
		test="${need_third_account_tip && not empty p2p:getPrincipal() && p2p:getCustomerAccount().hasOpenThirdAccount != '1'}">
		<div id="third_account_tip">
			<div class="div_width_980 text-center">
				<img src="${ctxStatic}/modules/front/images/util/!.png"> <span>&nbsp;&nbsp;&nbsp;您需要先开通第三方托管账户，才能开启您的【花生金服】安全投资之旅&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
				<a class="btn" target="_blank"
					href="${ctxFront }/customer/thirdAccount/open">立即开通</a>
			</div>
		</div>
	</c:if>
	<div class="div_bg_001">
		<div id="div_header_top" class="div_width_1080">
			<div class="div_left">
				<img id="logo" class="logo"
					src="${ctxStatic}/modules/front/images/util/logo.png" />
			</div>
			<div class="div_right">
				<ul class="top_menu">
					<li class="client">
						<!--<div class="popup width272" style=" width:272px; margin-left:-136px">-->
						<div class="popup width272"
							style="width: 144px; margin-left: -72px">
							<div class="popup_arrow"></div>
							<div class="popup_content">
                                <p><img src="${ctxStatic}/modules/front/images/util/img_app_tdc.png"><span>扫一扫下载<br>花生金服客户端</span></p>
                            </div>
						</div> <i class="icon_phone"></i> <a href="${ctxFront }/downloadApp">手机客户端</a>
					</li>
					...
					<li class="follow ml0">
						<div class="popup"
							style="width: 144px; left: 50%; margin-left: -72px">
							<div class="popup_arrow"></div>
							<div class="popup_content">
								<p>
									<img
										src="${ctxStatic}/modules/front/images/util/img_tdc.png"><span>扫一扫关注<br>花生金服微信
									</span>
								</p>
							</div>
						</div> <a href="javascript:;" class="icon_wechat"></a>
					</li>
					...
					<li class="follow">
						<div class="popup"
							...
							<div class="popup_content">
								<p>
									点击关注花生金服微博<a href="http://weibo.com/hsbank360" target="_blank" class="btn_text_gold"><br>@花生金服</a>
								</p>
							</div>
						</div> <a href="http://weibo.com/hsbank360" target="_blank" class="icon_weibo"></a>
					</li>
                    <li class="line"></li>
		...
		<div id="div_main_menu" class="div_width_1080">
			<ul id="menu_bar">
				<li class="${menu == 'wytz'? 'selected wytz_selected' : 'wytz'}"><a
					href="${ctxFront}/wytz"></a></li>
				<li class="${menu == 'wyrz'? 'selected wyrz_selected' : 'wyrz'}"><a
					href="${ctxFront}/willloan/willloan"></a></li>
				<li class="${menu == 'zxhd'? 'selected zxhd_selected' : 'zxhd'}"><a
					href="${ctxFront}/zxhd"></a></li>
				<!-- <li class="${menu == 'xszy'? 'selected xszy_selected' : 'xszy'}"><a
					href="${ctxFront}/xszq"></a></li> -->
				<li class="${menu == 'gywm'? 'selected gywm_selected' : 'gywm'}"><a
					href="${ctxFront}/gywm/index"></a></li>
				<li class="${menu == 'wdzh'? 'selected wdzh_selected' : 'wdzh'}"><a
					href="${ctxFront}/customer/summary"></a></li>
			</ul>
