		...
		<div class="zjgl_xxqr">
	    	...
	    	<div class="xxqr_info">
	        	<dl class="formList clearfix">
	                <dt>项目名称：</dt>
	                <dd class="center">${p2p:abbrev(cInfo.name, 100) }</dd>
	            </dl>
	        	<dl class="formList clearfix">
	                <dt>年化利率：</dt>
	                <dd class="center"><fmt:formatNumber value="${cInfo.rate }" type="percent" maxFractionDigits="1" /></dd>
	            </dl>
	        	<dl class="formList clearfix">
	                <dt>投资金额：</dt>
    ...
    <div class="pop_main" style=" width:530px; height:178px; margin-left:-265px; margin-top:-79px;">
        ...
        <div class="pop_content">
            <div class="btn_group_one">
                <a href="${ctxFront}/currentAccount/myChangeInto?projectId=${cInfo.id}" class="btn_brown_158x31">已完成投资支付</a>
                <a href="${ctxFront}/current/currentProjectDetail?id=${cInfo.id}" class="btn_blue_158x31">投资支付遇到问题</a>
            </div>
        </div>
    </div>
</div>
