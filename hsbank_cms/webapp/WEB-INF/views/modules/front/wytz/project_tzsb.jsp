...
<div class="content980">
	...
	<div class="tzcg">
    	<div class="tzsb_1">
        	<p><em class="red-text">*&nbsp;</em><span>${description }</span></p>
        </div>
        ...
        <div class="btn_brown_158x38" style="margin-bottom:80px;"><a href="${ctxFront }/project_detail?id=${projectBaseInfo.projectId }">返回项目详情页</a></div>
    </div>
