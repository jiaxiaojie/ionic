...
<body>
	...
	<div class="wdzh-main">
		<div id="tab_bar" class="messages-bar">
	        <li id="item_1" onClick="selectItem(1)" class="item"><span class="selected">账户消息</span></li>
	        <li id="item_2" onClick="selectItem(2)" class="item"><span>系统消息</span></li>
    ...
    <div id="popup" class="pop_bg" style="display:none">
		...
		<script type="text/javascript">
			function page(n,s) {
				var url = "${ctxFront}/customer/message/myMessage?pageNo=" + n;
