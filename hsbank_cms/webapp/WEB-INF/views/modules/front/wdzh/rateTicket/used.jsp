	...
	<body>
		...
		<div id="content_center" class="bg_789_middle">
			<div id="tab_bar">
				...
				<li id="item_2" onClick="selectItem(2)" class="item"><span class="selected">已使用现金券</span></li>
				<li id="item_3" onClick="selectItem(3)" class="item"><span>已失效现金券</span></li>
			</div>
			<!-- 可使用现金券 -->
			...
			<script type="text/javascript">
				function page(n,s) {
					var url = "${ctxFront}/customer/ticket/wdyhj_ysy?pageNo=" + n;
