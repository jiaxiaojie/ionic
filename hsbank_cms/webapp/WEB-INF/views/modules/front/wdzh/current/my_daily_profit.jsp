	...
	<body>		
		...
		<div id="content_center" class="bg_789_middle" style="width:769px;">
			<div id="tab_bar" style="padding-left:20px;">
				<li id="item_1" onClick="selectItem(1)" class="item"><span class="selected">收益</span></li>
				<li id="item_2" onClick="selectItem(2)" class="item"><span>投资</span></li>
				<li id="item_3" onClick="selectItem(3)" class="item"><span>赎回</span></li>
			</div>
			<!-- 待收款明细 -->
			<div id="earnings" style="display: block; padding:0 26px;">
				...
				<table class="table table-hover mb0">
					...
					<tbody>
						...
						<tr>
							...
							<td><fmt:formatNumber value="${interest.changeValue}" pattern="##0.0000" /></td>
		        ...
		        <script type="text/javascript">
			        function page(n,s) {
						var url = "${ctxFront}/currentAccount/myDailyProfit?projectId=${holdInfo.projectId }&pageNo=" + n;
