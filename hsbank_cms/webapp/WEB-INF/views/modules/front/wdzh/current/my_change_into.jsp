	...
	<body>		
		...
		<div id="content_center" class="bg_789_middle" style="width:769px;">
			<div id="tab_bar" style="padding-left:20px;">
				...
				<li id="item_2" onClick="selectItem(2)" class="item"><span class="selected">投资</span></li>
			...
			<div id="earnings" style="display: block; padding:0 26px;">
		        ...
		        <script type="text/javascript">
			        function page(n,s) {
						var url = "${ctxFront}/currentAccount/myChangeInto?projectId=${holdInfo.projectId }&pageNo=" + n;
