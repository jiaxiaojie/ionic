...
<html>
	<head>
		...
		<title>提现<c:choose><c:when test="${isSuccess }">成功</c:when><c:otherwise>失败</c:otherwise></c:choose></title>
		<c:if test="${isSuccess }">
	...
	<body>
		<div class="content980">
			<div class="zjgl_xxqr">
		    	...
		    	<div class="xxqr_title blue-text"><i class="blue_check"></i>提现成功！</div>
		        <div class="zhgl_wxkt">
		        	<p>页面将在<span id="remainSeconds" style="color:red;"></span>秒钟后跳转至交易记录。如果没有跳转，请直接点击</p>
		        </div>
		    	</c:when>
		    	<c:otherwise>
