...
<html>
	<head>
		...
		<link href="${ctxStatic}/modules/front/css/index/zxgg.css?${version }" rel="stylesheet"/>
		<title></title>
	</head>
	<body>
		<div id="content_area">
			<div class=zxgg_list>
				<c:if test="${category.module eq 'article'}">
					<table class="table table-hover">
						...
						<tr>
							<td width="90%"><a href="${article.urlWithZxgg}" style="color:${article.color}">${fns:abbr(article.title,96)}</a></td>
