...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/integral/integralMallProduct/reviewList">上架产品审核列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="integralMallProduct" action="${ctx}/integral/integralMallProduct/reviewList" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<ul class="ul-form">
			<li><label>产品名称：</label>
				<form:input path="productName" htmlEscape="false" maxlength="300" class="input-medium"/>
			</li>
			<li><label>产品类别：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="integralMallProduct">
			<tr>
				<td><a href="${ctx}/integral/integralMallProduct/reviewForm?id=${integralMallProduct.productId}">
				...
				<shiro:hasPermission name="integral:integralMallProduct:edit"><td>
    				<a href="${ctx}/integral/integralMallProduct/reviewForm?id=${integralMallProduct.productId}">审批</a>
