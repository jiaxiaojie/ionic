...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/integral/integralMallProduct/querylist">上架产品列表</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="integralMallProduct">
			<tr>
				<td><a href="${ctx}/integral/integralMallProduct/queryForm?id=${integralMallProduct.productId}">
