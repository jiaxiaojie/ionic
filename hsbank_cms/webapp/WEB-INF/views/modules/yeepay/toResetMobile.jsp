...
<body>
	<div id="lA11" class="tab-pane">
		<h3>11修改手机号明细</h3>
		<hr />
		<form:form class="form-horizontal" modelAttribute="toResetMobileReq"
			action="${ctx}/yeepay/toResetMobile1">
			...
			<div class="form:form-actions">
				<input id="lA11Go" class="btn btn-success" type="submit" value="确定" />
			</div>
		</form:form>
	</div>
</body>
