...
<body>
		 <h3>4绑卡明细</h3>
		<hr />
		<form:form class="form-horizontal" modelAttribute="toBindBankCardReq"
			action="${ctx}/yeepay/toBindBankCard1">
			...
			<div class="form:form-actions">
				<input id="lA4Go" class="btn btn-success" type="submit" value="确定" />
			</div>
		</form:form>
</body>
</html>