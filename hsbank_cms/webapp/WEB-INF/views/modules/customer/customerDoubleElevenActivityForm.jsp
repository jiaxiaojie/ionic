...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/customer/customerDoubleElevenActivity/">双11活动手动送现金列表</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="customerDoubleElevenActivity" action="${ctx}/customer/customerDoubleElevenActivity/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="changeReason" htmlEscape="false" maxlength="300" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="opDt" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${customerDoubleElevenActivity.opDt}" pattern="yyyy-MM-dd HH:mm:ss"/>"
