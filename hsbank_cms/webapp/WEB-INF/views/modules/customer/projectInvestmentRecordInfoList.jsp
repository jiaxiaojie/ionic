...
<body>
	...
	<form:form id="searchForm" modelAttribute="projectInvestmentRecord" action="${ctx}/customer/customerAccountInfo/projectInvestmentRecordInfo/" method="post" class="breadcrumb form-search">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<input id="investmentUserId" name="investmentUserId" type="hidden" value="${model.accountId}"/>
		<ul class="ul-form">
			<li><label>投资时间：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="projectInvestmentRecord">
			<tr>
				<td>
					${projectInvestmentRecord.pb.projectName}
				</td>
				<td>
				...
				<td>
					${projectInvestmentRecord.amount}
				</td>
				<td>
					${projectInvestmentRecord.actualAmount}
				</td>
				<td>
					${projectInvestmentRecord.ticketAmount}
				</td>
				<td>
					${projectInvestmentRecord.platformAmount}
				</td>
				<td>
