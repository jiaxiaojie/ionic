...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/carousel/adPositionInfo/">广告位显示信息列表</a></li>
		<%--<shiro:hasPermission name="carousel:adPositionInfo:edit"><li><a href="${ctx}/carousel/adPositionInfo/form">广告位显示信息添加</a></li></shiro:hasPermission>--%>
	<li><a href="${ctx}/carousel/adPositionInfo/createForm">广告位显示信息添加</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="adPositionInfo" action="${ctx}/carousel/adPositionInfo/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="adPositionInfo">
			<tr>
				<td><a href="${ctx}/carousel/adPositionInfo/form?id=${adPositionInfo.id}">
			...
			<%--	<td>
				...
				<%--<td>
					${adPositionInfo.version}
				</td>--%>
				<td>
					${fns:getDictLabel(adPositionInfo.status, 'shenghe', '')}
				</td>
				<shiro:hasPermission name="carousel:adPositionInfo:edit"><td>
    				<a href="${ctx}/carousel/adPositionInfo/form?id=${adPositionInfo.id}">修改</a>
					<a href="${ctx}/carousel/adPositionInfo/delete?id=${adPositionInfo.id}" onclick="return confirmx('确认要删除该广告位显示信息吗？', this.href)">删除</a>
