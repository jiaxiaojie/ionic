	...
	<body>
        ...
        <div class="app-content">
             <div class="yp-main">
                ...
                <form id="resetTransPwdForm" action="${resetTransPwdUrl }" method="post">
                ...
                <div class="yp-btn hs-margin-top-10">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12">
                                <a href="javascript:void(0);" class="btn btn-danger btn-block btn-md" onclick="toResetTransPwd()">前往重置</a>
                            </div>
                        </div>
                    </div>
                </div>
