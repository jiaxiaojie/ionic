	...
	<body>
             ...
             <div class="yp-main">
              <c:choose>
                ...
                <div class="container hs-margin-top-10">
                    <div class="row">
                        <div class="col-xs-12 font-size-12 text-success">开通易宝支付资金托管账号成功！</div>
                    </div>
                </div>
               </c:when>
               <c:otherwise>
                    <div class="container hs-margin-top-10">
                    <div class="row">
                        <div class="col-xs-12 font-size-12 text-success">易宝支付账号开通失败，请重试</div>
                    </div>
                </div>
               </c:otherwise>
               </c:choose>
        ...
        <script type="text/javascript">
            ...
            if(mobileType == "WECHAT" || mobileType == "WEB"){
            	...
            	window.WebJavaScript.registerReturn();
