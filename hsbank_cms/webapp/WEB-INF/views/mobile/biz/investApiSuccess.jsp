             ...
             <div class="yp-main">
                ...
                <div class="yp-body">
                    <ul class="list-group menu hs-margin-top-10">
                        ...
                        <li class="list-group-item">
                            <span>投资金额：</span>
                            <span class="menu-text-right pull-right">${investmentRecord.amount }元  <c:if test="${investmentRecord.ticketAmount > 0 }">&nbsp;&nbsp;使用了 ${investmentRecord.ticketAmount }元 现金券</c:if></span>
                        </li>
                        <li class="list-group-item">
                            <span>年化利率：</span>
