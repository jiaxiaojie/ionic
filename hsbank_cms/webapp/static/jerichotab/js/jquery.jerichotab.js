...
$.extend($.fn, {
    ...
    buildIFrame: function(src) {
        return this.each(function() {
            ...
            if(isiOS){
            	iframe = $('<div style="min-height:250px;max-height:1300px;-webkit-overflow-scrolling: touch;overflow-y: auto;position:fixed;"><iframe style="width:100%;" id="' + jerichotabiframe + '" name="' + jerichotabiframe + '" src="' + src + '" frameborder="0" scrolling="no" /></div>')
				.css({ width: '100%'}).appendTo($(this));
            }
            else{
            	
            	iframe = $('<iframe id="' + jerichotabiframe + '" name="' + jerichotabiframe + '" src="' + src + '" frameborder="0" scrolling="auto" />')
