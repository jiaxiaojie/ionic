...
public class Article extends DataEntity<Article> {
	...
	public void setPosidList(List<String> list) {
   	...
   	/**
   	 * 获取最新活动文章的链接地址
   	 * 前台使用：href="${article.urlWithZxhd}"
   	 * @return
   	 */
   	public String getUrlWithZxhd() {
   		return CmsUtils.getUrlDynamicWithZxhd(this);
   	}
   	
   	/**
   	 * 获取最新公告文章的链接地址
   	 * 前台使用：href="${article.urlWithZxgg}"
   	 * @return
   	 */
   	public String getUrlWithZxgg() {
   		return CmsUtils.getUrlDynamicWithZxgg(this);
   	}
   	
   	/**
   	 * 获取富定新闻文章的链接地址
   	 * 前台使用：href="${article.urlWithFdxw}"
   	 * @return
   	 */
   	public String getUrlWithFdxw() {
   		return CmsUtils.getUrlDynamicWithFdxw(this);
   	}
}
