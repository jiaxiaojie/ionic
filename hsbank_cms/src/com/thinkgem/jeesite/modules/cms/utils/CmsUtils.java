...
public class CmsUtils {
     ...
     * 获得【最新活动】文章动态URL地址
   	 ...
   	 * @return url
   	 */
    public static String getUrlDynamicWithZxhd(Article article) {
        if(StringUtils.isNotBlank(article.getLink())){
            return article.getLink();
        }
        StringBuilder str = new StringBuilder();
        str.append(context.getContextPath()).append(Global.getFrontPath());
        str.append("/zxhd/article-").append(article.getCategory().getId()).append("-").append(article.getId()).append(Global.getUrlSuffix());
        return str.toString();
    }
     ...
     * 获得【最新公告】文章动态URL地址
   	 ...
   	 * @return url
   	 */
    public static String getUrlDynamicWithZxgg(Article article) {
        if(StringUtils.isNotBlank(article.getLink())){
            return article.getLink();
        }
        StringBuilder str = new StringBuilder();
        str.append(context.getContextPath()).append(Global.getFrontPath());
        str.append("/index/zxgg/article-").append(article.getCategory().getId()).append("-").append(article.getId()).append(Global.getUrlSuffix());
        return str.toString();
    }
     ...
     * 获得【富定新闻】文章动态URL地址
   	 ...
   	 * @return url
   	 */
    public static String getUrlDynamicWithFdxw(Article article) {
        if(StringUtils.isNotBlank(article.getLink())){
            return article.getLink();
        }
        StringBuilder str = new StringBuilder();
        str.append(context.getContextPath()).append(Global.getFrontPath());
        str.append("/index/fdxw/article-").append(article.getCategory().getId()).append("-").append(article.getId()).append(Global.getUrlSuffix());
        return str.toString();
    }
}