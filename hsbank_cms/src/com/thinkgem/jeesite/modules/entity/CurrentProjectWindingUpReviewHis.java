 ...
 * @version 2015-12-09
 */
public class CurrentProjectWindingUpReviewHis extends DataEntity<CurrentProjectWindingUpReviewHis> {
	...
	public CurrentProjectWindingUpReviewHis() {
		super();
	}

	public CurrentProjectWindingUpReviewHis(String id){
		super(id);
	}
