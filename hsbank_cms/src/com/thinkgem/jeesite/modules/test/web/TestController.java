...
//		return "redirect:" + adminPath + "/test/test/?repage";
	...
	public static void main(String[] args) {
		String[] ts = {"1","1","2","2","3","4"};
		int[] as = {39230,44999,40880,22032,1512,33120,21815,38913,36640,47285,58768,43449,33122,34354,55061,46326,23292,46180,46293,38752,66378};
		String s1 = "INSERT INTO `customer_investment_ticket` (`account_id`,`ticket_type_id`,`get_dt`,`invalid_dt`,`get_remark`,`use_dt`,`use_remark`,`status`) VALUES ('";
		String s3 = "','";
		String s5 = "',now(),'2016-05-28 00:00:00','裘老板婚礼赠送',NULL,NULL,'0');";
		for(String t : ts) {
			for(int a : as) {
				System.out.println(s1 + a + s3 + t + s5);
			}
		}
	}
}
