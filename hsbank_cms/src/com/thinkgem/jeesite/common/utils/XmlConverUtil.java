...
public class XmlConverUtil {
	...
	public static String maptoXml(Map<String,Object> map) {
		...
		Element nodeElement = document.addElement("extend");
		for (Object obj : map.keySet()) {
			Element keyElement = nodeElement.addElement("property");
			keyElement.addAttribute("name", String.valueOf(obj));
			keyElement.addAttribute("value", String.valueOf(obj));
//			keyElement.setText(String.valueOf(map.get(obj)));
	...
	public static void main(String[] args){
		...
		aa.put("222", "aaa");
		aa.put("333", "ccc");
		System.out.println(maptoXml(aa));
	...
	public static String listtoXml(List<Object> list) throws Exception {
		...
		for (Object o : list) {
			...
			if (o instanceof Map) {
				for (Object obj : ((Map<String,Object>) o).keySet()) {
					Element keyElement = nodeElement.addElement("key");
					keyElement.addAttribute("label", String.valueOf(obj));
					keyElement.setText(String.valueOf(((Map<String,Object>) o).get(obj)));
				}
			} else {
				Element keyElement = nodeElement.addElement("key");
	...
	public static List<Map<String,Object>> xmltoList(String xml) {
		try {
			...
			List<Object> nodes = nodesElement.elements();
