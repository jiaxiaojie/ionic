...
public class Servlets {
	...
	public static boolean isAjaxRequest(HttpServletRequest request) {
		...
		try {
			...
			if (subject != null) {
				Object prin = subject.getPrincipal();
				if (prin instanceof Principal) {
					...
					com.thinkgem.jeesite.modules.sys.security.SystemAuthorizingRealmFront.Principal principal = (com.thinkgem.jeesite.modules.sys.security.SystemAuthorizingRealmFront.Principal) prin;
					if ((principal != null && principal.isMobileLogin())) {
						isMobile = true;
					}
				}
		...
		return ((accept != null
				...
				|| (xRequestedWith != null && xRequestedWith
						.indexOf("XMLHttpRequest") != -1) || isMobile));
	}
